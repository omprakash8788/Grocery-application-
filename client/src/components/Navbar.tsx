...
//   const user: any = null; // Just for testing 
  ...
  return (
    <nav className="bg-white sticky top-0 z-50 border border-b border-app-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
        ...
        <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {/* so when yiu click here it will open sidebar  wherr display the cart data*/}
            ...
            <div className="relative">
              {user ? (
                <button
                  ...
                  className="flex items-center gap-2 p-2 rounded-lg hover:bg-zinc-100 transition"
                >
                ...
                <div className="flex-center gap-2">
                  <Link
                    to="/login"
                    className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-950 rounded-full hover:bg-green-900"
                  >
                    <UserIcon size={16} />
                    Sign In
                  </Link>
