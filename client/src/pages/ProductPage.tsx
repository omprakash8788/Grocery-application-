        ...
        <div className="bg-white/50 rounded-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              <span className="text-sm font-medium text-app-text-light tracking-wider mb-2 capitalize">
                {categoryLabel}
              </span>
              ...
              {/* desc */}
              <div className="text-sm text-app-text-light leading-relaxed mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center border border-app-border rounded-xl overflow-hidden">
                  <button
                    onClick={handleMinus}
                    className="p-3 hover:bg-app-cream transition-all"
                  >
