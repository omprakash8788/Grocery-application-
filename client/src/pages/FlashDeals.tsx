...
const FlashDeals = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => setLoading(false), 1000); //After one second it will display the products
  }, []);
    ...
    <div className="min-h-screen bg-app-cream">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 md:grid-cols-4 gap-4">
            {products.map(
              (product) =>
                product.stock > 0 && (
