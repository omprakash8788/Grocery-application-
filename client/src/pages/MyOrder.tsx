      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <Link
              to="/products"
              className="inline-flex px-4 py-2 bg-app-green text-white text-smm rounded-lg"
            >
              Start Shopping
            </Link>
          </div>
                ...
                <div className="flex items-center gap-2 mb-3">
                  {
                    order.items.slice(0,4).map((item, i)=>(
                        <img className="size-12 sm:size-12 rounded-lg object-cover border border-app-border" key={i} src={item.image} alt={item.name} />
                    ))
                  }
                  {
